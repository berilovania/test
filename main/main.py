...
REGION_BATTLE = (1390, 24, 164, 46)
REGION_SCREEN = (768, 102, 957, 702)
REGION_LOOT = (1165, 370, 167, 167)
REGION_MAP = (1749, 26, 116, 116)
REGION_CENTER_MAP = (1801, 77, 9, 9)
REGION_TARGET_LINE = (1395, 36, 22, 3)
REGION_AMULET = (1753, 185, 32, 32)
REGION_RING = (1753, 257, 32, 32)
CENTER_FLOR = (1248, 461)
REGION_FLOR_LEVEL = (1890, 71, 25, 70)
FLOR_LEVEL = None
LIFE_STATUS = (218, 79, 79)
FULL_LIFE_STATUS = (218, 79, 79)
MANA_STATUS = (83, 80, 217)
REGION_BUF_BAR = (1752, 314, 105, 10)
...
def check_status():
    ...
    if pg.pixel(1856, 147) != FULL_LIFE_STATUS:
        if pg.pixel(1790, 147) != LIFE_STATUS:
            pg.press('3')
        elif pg.pixel(1822, 147) != LIFE_STATUS:
            pg.press('2')
        elif pg.pixel(1848, 147) != LIFE_STATUS:
            pg.press('1')
        pg.sleep(0.3)
    if event_th.is_set():
        return
    if pg.pixel(1856, 160) != MANA_STATUS:
        if pg.pixel(1790, 160) != MANA_STATUS:
            pg.press('f')
        pg.sleep(0.3)
